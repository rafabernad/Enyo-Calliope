...
enyo.kind({
	...
	restoreSelection : function() {
		range = this.editorWindow.document.createRange();
		range.selectNodeContents(this.editorWindow.document);
	...
	resizeHandler : function() {
		this.inherited(arguments);
		if(this.container.kind === "onyx.InputDecorator") {
			this.$.EditorOwner.applyStyle('height', (this.hasNode().clientHeight + 4) + 'px');
